...
public class IterPlayerData {
    ...
    public void copyFrom(IterPlayerData source) {
        ...
        this.spellweaverSwitch = source.spellweaverSwitch; // Add this
    }
    ...
    public void saveNBT(CompoundTag nbt) {
        ...
        nbt.putBoolean("SpellweaverSwitch", spellweaverSwitch); // Add this
    ...
    public void loadNBT(CompoundTag nbt) {
        ...
        spellweaverSwitch = nbt.getBoolean("SpellweaverSwitch"); // Add this
