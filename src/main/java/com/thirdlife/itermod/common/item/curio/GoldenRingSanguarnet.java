...
public class GoldenRingSanguarnet extends Item implements ICurioItem {
    public GoldenRingSanguarnet() {
    ...
    public void ringSend(SlotContext slotContext) {
        RingEffectManager.TieredRingStuff("iter_ring_regeneration", "Ring Regeneration", ModAttributes.REGENERATION.get(),
