...
public class GnawerGuiScreen extends AbstractContainerScreen<GnawerGuiMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("iter:textures/gui/gnawer_gui.png");
    ...
    public void init() {
        ...
        button_book = new ImageButton(this.leftPos + 71, this.topPos + 64, 32, 16,
                0, 0, 16, new ResourceLocation("iter:textures/gui/atlas/gnawer_book.png"),
                32, 32, e -> {
            iterMod.PACKET_HANDLER.sendToServer(new GnawerGuiButtonPacket(0, x, y, z));
        });
