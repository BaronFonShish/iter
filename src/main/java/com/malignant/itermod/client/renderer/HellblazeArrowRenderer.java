...
import com.malignant.itermod.client.model.GenericArrowModel;
import com.malignant.itermod.common.entity.misc.HellblazeArrowEntity;
...
public class HellblazeArrowRenderer extends EntityRenderer<HellblazeArrowEntity> {
    private static final ResourceLocation texture = new ResourceLocation("iter", "textures/entity/hellblaze_arrow.png");
