...
public abstract class AbstractMagicProjectile extends AbstractArrow {
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (target instanceof LivingEntity livingTarget) {
            if (livingTarget.hurt(new DamageSource(level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.MOB_PROJECTILE), this.getOwner()), damage)) {
